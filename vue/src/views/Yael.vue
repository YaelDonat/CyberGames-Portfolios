      ...
      <div class="bg-white shadow-xl rounded grid grid-rows-2 lg:grid-rows-1 lg:grid-cols-3">
        ...
        <div class="row-span-1 col-span-1 space-y-4 pt-20 bg-gradient-to-b from-green-100 to-blue-100 dark:from-gray-200 dark:to-gray-400">
          ...
          <div class="flex flex-col justify-start items-center pb-8">
            <div>
              <img class="inline-block w-52 h-52 xl:h-72 xl:w-72 rounded-full ring-2 ring-white object-cover mb-4"  src='https://tinyurl.com/3awfv77b' alt="me">
            </div>
            <div>
              <h1 class="text-gray-800 text-3xl font-semibold mb-2">DONAT Yaël</h1>
            </div>
            <div>
              <h2 class="text-gray-700">Développeur full-stack junior</h2>
            </div>
          </div>
          ...
          <div class="flex flex-col justify-start items-start pl-8 md:pl-2 xl:pl-12 space-y-4">
            ...
            <div class="flex justify-around items-center space-x-4">
              ...
              <div><h4 class="sm:text-base 2xl:text-xl text-gray-700 lg:leading-loose sm:leading-relaxed sm:tracking-relaxed">donatyael@gmail.com</h4></div>
            </div>
            <div class="flex justify-around items-center space-x-4">
              <div><fa icon="phone"/></div>
              <div><h4 class="sm:text-base 2xl:text-xl text-gray-700 lg:leading-loose sm:leading-relaxed sm:tracking-relaxed">+33 24 41 65 15</h4></div>
            </div>
            <div class="flex justify-around items-center space-x-4">
              <div><fa icon="male"/></div>
              <div><h4 class="sm:text-base 2xl:text-xl text-gray-700 lg:leading-loose sm:leading-relaxed sm:tracking-relaxed">14 rue Guichard</h4></div>
            </div>
          </div>
          ...
          <div class="flex flex-col justify-start items-start pl-8 md:pl-2 xl:pl-12 pt-8 space-y-4">
            ...
            <div class="flex justify-around items-center space-x-4">
              ...
              <div><h4 class="sm:text-base 2xl:text-xl text-gray-700 lg:leading-loose sm:leading-relaxed sm:tracking-relaxed">Né le 28 mars 2001</h4></div>
            </div>
            <div class="flex justify-around items-center space-x-4">
              <div><fa :icon="['fa','cookie']"/></div>
              <div><h4 class="sm:text-base 2xl:text-xl text-gray-700 lg:leading-loose sm:leading-relaxed sm:tracking-relaxed">Aime la cuisine</h4></div>
            </div>
          </div>
          ...
          <div class="flex flex-col justify-start items-start pl-8 md:pl-2 xl:pl-12 pt-8 space-y-4">
            ...
            <div class="flex justify-around items-center space-x-4">
              ...
              <div><a href="https://www.linkedin.com/in/yael-donat/" target="_blank" class="sm:text-base 2xl:text-xl hover:text-turquoise text-gray-700 lg:leading-loose sm:leading-relaxed sm:tracking-relaxed">LinkedIn</a></div>
            </div>
            <div class="flex justify-around items-center space-x-4">
              <div><fa :icon="['fab','github']"/></div>
              <div><a href="https://github.com/YaelDonat" target="_blank" class="sm:text-base 2xl:text-xl hover:text-turquoise text-gray-700 lg:leading-loose sm:leading-relaxed sm:tracking-relaxed">Github</a></div>
            </div>
          </div>
