<template>
    <section>
        ...
        <div
            class="from-blue-300 bg-gradient-to-r sm:px-6 md:px-12 lg:px-24 lg:py-24 2xl:px-12 px-4 py-12 mx-auto"
        >
            <div class="2xl:max-w-7xl flex flex-wrap items-center mx-auto">
                <div
                    class="lg:flex-grow lg:w-1/2 lg:pr-24 md:mb-0 flex flex-col items-start mb-16 text-left"
                >
                    <span
                    ...
                    <dl class="md:grid-cols-2 grid grid-cols-1 gap-12">
                        <div>
                            <dt
                                class="bg-blue-50 inline-flex items-center justify-center flex-shrink-0 w-12 h-12 mb-5 text-blue-600 rounded-full"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="icon icon-tabler icon-tabler-aperture w-6 h-6"
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                                    stroke-width="1.5"
                            ...
                            <dd class="flex-grow">
                                <h2
                                    class="text-neutral-600 mb-3 text-lg font-medium tracking-tighter"
                                >
                                    Objectifs
                                </h2>
                                <p
                                ...
                                >
                                    Explain 2 great feature here. Information
                                    about the feature.
                                </p>
                                <a
                                    href="#"
              ...
              <div class="relative pt-8">
                ...
                <div
                    class="lg:w-5/6 lg:max-w-lg rounded-xl xl:mt-0 w-full mt-12"
                >
                    <div>
                        <div class="relative w-full max-w-lg">
                            <div
                                class="bg-violet-300 -left-4 w-72 h-72 mix-blend-multiply filter blur-xl opacity-70 animate-blob absolute top-0 rounded-full"
                            ></div>
                            <div
        ...
        >
            <div
                class="flex flex-col mb-6 lg:justify-between lg:flex-row md:mb-8"
            >
                <h2
        ...
        >
            <div>
                ...
                <p class="font-bold">
                    ACME Industries Ltd. <br />Providing reliable tech since
                    1992
                </p>
